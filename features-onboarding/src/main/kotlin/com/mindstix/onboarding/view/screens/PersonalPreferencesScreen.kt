...
fun PersonalPreferencesScreen(
    ...
    Column(
        ...
        Image(
            ...
            painter = painterResource(id = com.mindstix.capabilities.R.drawable.imgpf),
            contentDescription = "Google Login",
        )
        Spacer(modifier = Modifier.height(10.dp))
        questions.subList(3, questions.size - 1).forEachIndexed { index, question ->
                    ...
                    Column {
                        LazyVerticalGrid(
                            ...
                            modifier = Modifier.height(
                                height = (((question.options.size + 1) / 2) * 52).dp
                            )
                        ) {
